...
export default function Hoodie1() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 py-8 px-4">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-[#70e000] hover:bg-black text-white hover:text-[#70e000] font-bold py-2 px-6 rounded-xl transition-colors duration-200 shadow"
          >
            Submit Order
          </button>
        </form>
  ...
  <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center mb-4">
            <span className="text-gray-700 font-semibold text-base mr-2">10k Reviews</span>
          ...
          {/* Show form if Buy Now clicked */}
          {showForm && (
            <form
              className="mt-4 bg-gray-50 p-6 rounded-xl shadow-md flex flex-col gap-4"
              onSubmit={e => {
                e.preventDefault();
                setSubmittedOrder({
                  hoodie: hoodieData.name,
