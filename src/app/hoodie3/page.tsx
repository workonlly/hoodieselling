...
export default function Hoodie3() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 py-8 px-4">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-[#70e000] hover:bg-red-700 text-white hover:text-[#70e000] font-bold py-2 px-6 rounded-xl transition-colors duration-200 shadow"
          >
            Submit Order
          </button>
        </form>
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8 flex flex-col md:flex-row items-center max-w-3xl w-full">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center mb-4">
            <span className="text-gray-700 font-semibold text-base mr-2">7k Reviews</span>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <button
                className={`w-8 h-8 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-[#70e000] ${selectedColor === 'Black' ? 'border-[#70e000]' : 'border-gray-300'} bg-black`}
                aria-label="Black"
              ...
              ></button>
              <button
                className={`w-8 h-8 rounded-full border-2 focus:outline-none focus:ring-2 focus:ring-[#70e000] ${selectedColor === 'White' ? 'border-[#70e000]' : 'border-gray-300'} bg-white`}
                aria-label="White"
